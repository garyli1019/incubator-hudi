...
class HoodieRealtimeInputFormat extends HoodieParquetInputFormat {
  //TODO: How Spark use this string?
  ...
  override def buildReaderWithPartitionValues(
    ...
    (file: PartitionedFile) => {
      ...
      log.info(s"fileSplit.getPath in HoodieRealtimeInputFormat: ${fileSplit.getPath} and ${fileSplit.getPath.getName}")
      log.info(s"logPath in HoodieRealtimeInputFormat: ${logPathStr.toString}")
...
//          null)
      ...
      //TODO: Can we use vectorized reader?
